...
3. Review the diff preview and redaction summary
4. Copy or download the sanitized output
...
3. **Test with the sample** in the help menu to verify behavior
4. **For large files**, use the "only changed lines" toggle to focus review effort
